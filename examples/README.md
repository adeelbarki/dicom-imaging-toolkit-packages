...
Runnable scripts against the real implementation in `src/`. Not published anywhere — this
project isn't packaged yet, so they import via relative paths (`../src/...`), same as the tests.
